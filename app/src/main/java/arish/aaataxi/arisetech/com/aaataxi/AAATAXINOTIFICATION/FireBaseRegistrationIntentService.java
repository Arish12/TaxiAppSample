...
import com.google.firebase.iid.FirebaseInstanceIdService;
 ...
 public class FireBaseRegistrationIntentService extends FirebaseInstanceIdService {
     ...
     private void storeRegIdInPref(String token) {
         SharedPreferences pref = getApplicationContext().getSharedPreferences(SharedPrefManager.SHARED_PREF_NAME, 0);
         SharedPreferences.Editor editor = pref.edit();
         editor.putString(SharedPrefManager.GCM_KEY, token);
         editor.commit();
